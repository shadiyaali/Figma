...
const Service = () => {
  return (
    <>
      ...
      <p className="text-[color:var(--Blue-1,#0e33cb)] text-center text-[16px] not-italic font-medium leading-[100%] tracking-[1.33px] uppercase
   
  font-family: 'Space Grotesk'">our services</p>
